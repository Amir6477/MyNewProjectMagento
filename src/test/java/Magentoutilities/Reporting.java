...
import Magentotestcases.Magentobase;
...
public class Reporting implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		reporter=new ExtentSparkReporter("C:\\Users\\amirk\\eclipse-workspace\\Magento\\Report\\newone.html");
	...
	public void onTestFailure(ITestResult tr) {
		...
		try {
			String imgPath=new Magentobase().captureScreen(tr.getName());
